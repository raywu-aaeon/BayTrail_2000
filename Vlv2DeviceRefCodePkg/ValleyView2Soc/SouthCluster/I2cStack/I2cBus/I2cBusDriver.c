...
//  DEBUG (( DEBUG_LOAD, "I2cBusDriverSupported entered\r\n" ));
  ...
  if ( !EFI_ERROR ( Status )) {
    DEBUG (( DEBUG_INFO, "I2C host found\r\n" ));
    ...
    Status = gBS->OpenProtocol ( Controller,
                                 ...
                                 EFI_OPEN_PROTOCOL_BY_DRIVER );
    if ( !EFI_ERROR ( Status )) {
      DEBUG (( DEBUG_INFO, "I2C bus enumeration data found\r\n" ));
  ...
  )
{
  ...
  if ( NULL == I2cBus ) {
    ...
    Status = gBS->OpenProtocol ( Controller,
                                 ...
                                 EFI_OPEN_PROTOCOL_BY_DRIVER );
    if ( !EFI_ERROR ( Status )) {
      DEBUG (( DEBUG_INFO, "0x%016Lx: I2C host protocol found\r\n", (UINT64)(UINTN)I2cHost ));
      ...
      Status = gBS->OpenProtocol ( Controller,
                                   ...
                                   EFI_OPEN_PROTOCOL_BY_DRIVER );
      if ( !EFI_ERROR ( Status )) {
        DEBUG (( DEBUG_INFO, "0x%016Lx: I2C host acpi protocol found\r\n", (UINT64)(UINTN)I2cHost ));
  ...
  //  Display exit
  //
  DEBUG (( DEBUG_INFO, "I2cBusDriverStart exiting, Status: %r\r\n", Status ));
  ...
  )
{
  ...
  //  Display exit
  //
  DEBUG (( DEBUG_INFO, "I2cBusDriverStop exiting, Status: %r\r\n", Status ));
