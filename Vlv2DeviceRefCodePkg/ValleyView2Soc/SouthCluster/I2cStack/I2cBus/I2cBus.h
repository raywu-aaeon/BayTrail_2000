...
///
#define DEBUG_I2C_DEVICE              0x10000000
...
#define I2C_DEVICE_CONTEXT_FROM_PROTOCOL(a) CR (a, I2C_DEVICE_CONTEXT, BusApi, I2C_DEVICE_SIGNATURE)  ///< Locate I2C_DEVICE_CONTEXT from protocol
...
struct _I2C_BUS_CONTEXT {
  ...
  ///
  CONST EFI_I2C_ACPI_PROTOCOL *I2cAcpi;
