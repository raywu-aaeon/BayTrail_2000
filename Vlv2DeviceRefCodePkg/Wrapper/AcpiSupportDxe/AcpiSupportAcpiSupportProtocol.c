...
)
{
    ...
    CopyMem(AcpiSupportInstance->Rsdp1->OemId, ACPI_OEM_ID_MAK, 6);
    ...
    CopyMem(AcpiSupportInstance->Rsdp3->OemId, ACPI_OEM_ID_MAK, 6);
    ...
    CopyMem(AcpiSupportInstance->Rsdt1->OemId, ACPI_OEM_ID_MAK, 6);
    ...
    CopyMem(AcpiSupportInstance->Rsdt3->OemId, ACPI_OEM_ID_MAK, 6);
    CurrentData = EFI_ACPI_OEM_TABLE_ID;
    ...
    CopyMem(AcpiSupportInstance->Xsdt->OemId, ACPI_OEM_ID_MAK, 6);
    CurrentData = EFI_ACPI_OEM_TABLE_ID;
