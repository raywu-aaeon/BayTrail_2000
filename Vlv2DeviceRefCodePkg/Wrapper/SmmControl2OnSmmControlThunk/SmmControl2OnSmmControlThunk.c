...
{
  EfiConvertPointer (0x0, (VOID **)&mSmmControl->Trigger);
  EfiConvertPointer (0x0, (VOID **)&mSmmControl->Clear);
  EfiConvertPointer (0x0, (VOID **)&mSmmControl->GetRegisterInfo);
...
//EIP140646 >>
  ...
  ///
  SmmControl2Clear(&gSmmControl2, FALSE);
  IoOr32 (PM_BASE_ADDRESS + R_SMI_EN, 0x21);
  Value = IoRead8 (PM_BASE_ADDRESS + R_SMI_EN);
  S3BootScriptSaveIoWrite (
    EfiBootScriptWidthUint8,
    (UINTN) (PM_BASE_ADDRESS + R_SMI_EN),
    1,
    &Value
    );
//EIP140646 <<
