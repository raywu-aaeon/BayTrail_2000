...
//CSP20130723_A - S3BootScriptSaveMemPoll function doesn¡¦t work properly issue >>
    mS3SaveState->Write(mS3SaveState, EFI_BOOT_SCRIPT_MEM_POLL_OPCODE, Width, Address, BitMask, BitValue, (UINT64)Duration, (UINT64)LoopTimes);
//CSP20130723_A - S3BootScriptSaveMemPoll function doesn¡¦t work properly issue <<
