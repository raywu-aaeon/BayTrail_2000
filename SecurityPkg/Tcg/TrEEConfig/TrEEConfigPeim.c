  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    ...
    TrEEConfiguration.RevokeTrust = FALSE;
  }
  ...
  if (TrEEConfiguration.RevokeTrust) {
    TrEEConfiguration.RevokeTrust = TRUE;
  }
  ...
  PcdSetBool (PcdRevokeTrust, TrEEConfiguration.RevokeTrust);
