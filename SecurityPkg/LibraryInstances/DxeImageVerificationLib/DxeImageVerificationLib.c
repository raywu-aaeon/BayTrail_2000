...
CHAR16  mNotifyString3[MAX_NOTIFY_STRING_LEN] = L"Certificate Verification Failed!!!";
CHAR16  mNotifyString4[MAX_NOTIFY_STRING_LEN] = L"Press Any Key To Return";
//
...
Done:
  if (Status != EFI_SUCCESS) {
    ...
    //
    CreatePopUp (EFI_LIGHTGRAY | EFI_BACKGROUND_BLUE, &Key, mNotifyString3, mNotifyString4, NULL);
