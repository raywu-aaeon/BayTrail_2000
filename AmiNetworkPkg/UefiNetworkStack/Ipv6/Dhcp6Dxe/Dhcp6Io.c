  ...
  )
{
  ...
  if (Callback != NULL) {
	...
	//
    //
    // If callback returns EF_ABORTED change the UdpStatus to EFI_ABORTED.
    //
...
{
  EFI_STATUS                  Status;
  //EFI_DHCP6_STATE             State;           AMI PORTING : Remove unused variable.
  UINT8                       *Option;
  UINT8                       *IaInnerOpt;
  UINT16                      IaInnerLen;
  UINT16                      StsCode;
  ...
  //
  // State  = Dhcp6Init;  AMI PORTING : Remove unused variable.
  ...
  )
{
  EFI_STATUS                  Status;
  UINT8                       *Option;
  //UINT16                      StsCode;  AMI PORTING : Remove unused variable.
  BOOLEAN                     Timeout;
  ...
  Timeout = FALSE;
  //StsCode = Dhcp6StsSuccess;            AMI PORTING : Remove unused variable.
