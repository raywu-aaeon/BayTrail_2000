...
//**********************************************************************
// $Header: /Alaska/BIN/Chipset/Intel/SouthBridge/IbexPeak/Chipset/Protocols/PIDEController.h 1     10/06/08 3:14a Tonywu $
//
// $Revision: 1 $
//
// $Date: 10/06/08 3:14a $
...
extern EFI_GUID gEfiSataControllerProtocolGuid;
...
#define		S3_RESUME_UNLOCK_HDD_PASSWORD		0x02			// Set bit 1 in Flags only if HDD loses power in S3 state.
...
typedef
EFI_STATUS
(*EFI_IDE_CONTROLLER_SET_DMA_TIMING) (
	IDE_DEVICE_INTERFACE		*IdeDevice
);

typedef
EFI_STATUS
(*EFI_IDE_CONTROLLER_GET_MODE) (
	IDE_DEVICE_INTERFACE		*IdeDevice
);

typedef
EFI_STATUS
(*EFI_IDE_CONTROLLER_GET_CONTROLLER_INFO) (
...
typedef
EFI_STATUS
(*EFI_IDE_DISABLE_ENABLE_CHANNEL) (
    EFI_PCI_IO_PROTOCOL			*PciIO,
	UINT8						Channel,
	UINT8						Device,
