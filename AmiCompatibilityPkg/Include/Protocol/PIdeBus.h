...
//**********************************************************************
// $Header: /Alaska/BIN/Core/Include/Protocol/PIDEBus.h 28    11/27/12 3:23a Rameshr $
//
// $Revision: 28 $
//
// $Date: 11/27/12 3:23a $
...
#define     DiPM_SUB_COMMAND                    0x03
#define     DiPM_ENABLE                         0x10
#define     DiPM_DISABLE                        0x90
#define     IDENTIFY_DiPM__SUPPORT              0x08
...
extern EFI_GUID gHddSecurityInitProtocolGuid;
extern EFI_GUID gHddSecurityEndProtocolGuid;
extern EFI_GUID gHddSmartInitProtocolGuid;
extern EFI_GUID gEfiIdeBusInitProtocolGuid;
