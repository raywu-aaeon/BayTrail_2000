...
typedef EFI_STATUS (*OEM_PCI_PROGRAM_DEVICE_FUNCTION_PTR)(VOID *PciIoProtocol);
typedef EFI_STATUS (*OEM_PCI_DEVICE_ATTRIBUTE_FUNCTION_PTR)(VOID *PciIoProtocol, UINT64 *Attr, UINT64 Capab, BOOLEAN Set);
typedef EFI_STATUS (*OEM_PCI_DEVICE_SET_ASPM_FUNCTION_PTR)(VOID *PciIoProtocol, VOID *AspmMode);
typedef EFI_STATUS (*OEM_PCI_DEVICE_SET_LNK_SPEED_FUNCTION_PTR)(VOID *PciIoProtocol, UINT8 *LnkSpeed, UINT8 SuppSpeeds);
typedef EFI_STATUS (*OEM_PCI_DEVICE_GET_OPT_ROM_FUNCTION_PTR)(VOID *PciIoProtocol, VOID **OptRom, UINT64 *OptRomSize);
typedef EFI_STATUS (*OEM_PCI_DEVICE_OUT_OF_RESOURCES_FUNCTION_PTR)(VOID *PciIoProtocol, UINTN Count, UINTN ResType);
//typedef EFI_STATUS (*OEM_PCI_PADDING_FUNCTION_PTR)(VOID *HpcData, VOID *HpcLocationData, UINT64 PciAddress);
