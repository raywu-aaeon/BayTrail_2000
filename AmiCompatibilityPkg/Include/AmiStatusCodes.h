...
//**********************************************************************
// $Header: /Alaska/BIN/Core/Include/AmiStatusCodes.h 12    8/16/10 4:24p Felixp $
//
// $Revision: 12 $
//
// $Date: 8/16/10 4:24p $
...
#define PEI_MEMORY_NOT_INSTALLED (EFI_SOFTWARE_PEI_CORE | EFI_SW_PEI_CORE_EC_MEMORY_NOT_INSTALLED)
...
#define PEI_RECOVERY_FAILED (EFI_SOFTWARE_PEI_MODULE | EFI_SW_PEI_EC_RECOVERY_FAILED)
...
//Reported by PEI Core
#define PEI_RESET_NOT_AVAILABLE (EFI_SOFTWARE_PEI_SERVICE | EFI_SW_PS_EC_RESET_NOT_AVAILABLE)
