...
//
// Input:       
//  BOOT_SECTOR_EX *pBS - pointer to data block to check
//
// Output:      
//  TRUE - data block is a exFAT structure
//  FALSE - data block is not a exFAT structure
//
//----------------------------------------------------------------------------
//<AMI_PHDR_END>
BOOLEAN IsExFat(
...
//  IN  BOOLEAN Contiguous - true if file is contiguous
...
//  IN  BOOT_SECTOR_EX *Bs - pointer to MBR
//
// Output:      
...
//----------------------------------------------------------------------
//
// Procedure:	FindFileInExFatDirectory
//
// Description:	
...
//  DIR_ENTRY_EX **EntryPtr - Pointer to buffer containing directory 
...
//----------------------------------------------------------------------
//<AMI_PHDR_END>
BOOLEAN FindFileInExFatDirectory(
    IN EFI_PEI_SERVICES     **PeiServices,
    IN  UINT8               *DirPtr,
...
//----------------------------------------------------------------------
//
// Procedure:	AmiGetFileListFromExFatVolume
//
// Description:	
...
//
// Input:
//  DIR_ENTRY_EX *Root - Pointer to a buffer containing the root directory
//  UINT32 RootEntries - Number of root entries
//  UINTN *NumberOfFiles - Pointer to number of files found
//  DIR_ENTRY_EX **Buffer - Pointer to buffer containing entry of
...
//----------------------------------------------------------------------
//<AMI_PHDR_END>
VOID AmiGetFileListFromExFatVolume(
    IN EFI_PEI_SERVICES     **PeiServices,
