...
{
    OHCI_HC_REGISTERS   *OhciHcReg = (OHCI_HC_REGISTERS *)OhciDevPtr->UsbHostControllerBaseAddress;
...
//
// Description: This routine resets the Host Controler 
//
...
)
{
    ...
    switch (Attributes) {
        case EFI_USB_HC_RESET_GLOBAL:
            ...
            OhciHcReg = (OHCI_HC_REGISTERS*)OhciDev->UsbHostControllerBaseAddress;
    ...
    OUT UINT32                     *TransferResult )
{
    ...
    *(UINT32 *) fpData = (UINT32) DataBuffer;
    ...
    Status = OhciHcWaitForTransferComplete( PeiServices,
                                            OhciDevPtr,
    ...
    IN POHCI_TD     Td )
{
    ...
    PEI_TRACE ((-1, PeiServices, "OHCI Time-Out:\n"));
    return EFI_NOT_FOUND;
