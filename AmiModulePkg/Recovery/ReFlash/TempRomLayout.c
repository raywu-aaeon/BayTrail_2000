...
#define AMI_ROM_LAYOUT_FV_PRE_BB_GUID \
{ 0xB73FE497, 0xB92E, 0x416e, 0x83, 0x26, 0x45, 0xAD, 0x0D, 0x27, 0x00, 0x91 }
...
//FV_PRE_BB
    { 
        AMI_ROM_LAYOUT_FV_PRE_BB_GUID,
        AMI_ROM_LAYOUT_FV_PRE_BB_ADDRESS,
        AMI_ROM_LAYOUT_FV_PRE_BB_OFFSET,
        AMI_ROM_LAYOUT_FV_PRE_BB_SIZE,
        0,
        AMI_ROM_AREA_SIGNED | AMI_ROM_AREA_VITAL | AMI_ROM_AREA_FV_PEI
    },
#endif //VERIFY_BOOT_SUPPORT
//FV_BB    
    { 
        AMI_ROM_LAYOUT_FV_BB_GUID,
        AMI_ROM_LAYOUT_FV_BB_ADDRESS,
