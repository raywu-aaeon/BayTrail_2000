...
//**********************************************************************
// $Header: /AptioV/Source/Modules/Ofbd/Ofbd.h $
//
// $Revision: $
//
// $Date: $
...
typedef VOID (EFIAPI OFBD_INIT_SMM_FUNC) (VOID);
typedef VOID (EFIAPI OFBD_INIT_PARTS_FUNC) (IN VOID * pOFBDBuffer, IN OUT UINT8 *pOFBDDataHandled);
