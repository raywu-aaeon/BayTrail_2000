...
//**********************************************************************
//**********************************************************************
// $Header: /Alaska/SOURCE/Modules/AHCI/AhciSmm/AhciSmm.c 10    8/17/12 3:14a Srikantakumarp $
//
// $Revision: 10 $
//
// $Date: 8/17/12 3:14a $
    ...
    )
{
    ...
    //
    // If the AhciBaseAddress is 0, Initilize the base address
    //
    if(!AhciBaseAddr) {
        //
        //Initilize the AHCI base address
        // 
        ...
        //
        //Initilize the Ahci Base addres 
        //
