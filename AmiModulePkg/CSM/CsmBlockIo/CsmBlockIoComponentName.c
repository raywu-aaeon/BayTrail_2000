...
/** @file CsmBlockIoComponentName.c
...
CHAR16 *gCsmBlockIoControllerName = NULL;

EFI_COMPONENT_NAME_PROTOCOL gCsmBlockIoComponentName = {
  CsmBlockIoComponentNameGetDriverName,
  CsmBlockIoComponentNameGetControllerName,
  "eng"
};
...
/**
    ...
    @param ChildHandle  The handle of the child controller to retrieve the name
        of.  This is an optional parameter that may be NULL.  It will be NULL for 
		device drivers.  It will also be NULL
