...
//**********************************************************************
//**********************************************************************
// $Header: /Alaska/SOURCE/Modules/HddSecurity/IdeSecuritySetup.c 3     1/15/10 10:22a Yul $
//
// $Revision: 3 $
//
// $Date: 1/15/10 10:22a $
...
#if defined(AmiChipsetPkg_SUPPORT) && AmiChipsetPkg_SUPPORT
static EFI_GUID                gSbHddPolicyProtocolGuid = SB_HDD_POLICY_PROTOCOL_GUID;
