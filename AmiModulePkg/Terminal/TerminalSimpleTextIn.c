...
//
// Description: Calls SerialIo->Read to read characters from the serial port.
...
//<AMI_PHDR_START>
//
// Procedure: FillRawBuffer
//
// Description: Fills our internal raw buffer TerminalDev->RawFIFO
    ...
    UINTN *Size)
{
    ...
    *Size = TempSize;
    ...
    //
    if (TempSize < FillSize1 || !FillSize2) return; 
...
//<AMI_PHDR_START>
//
// Procedure: RemoveCharFromRawBuffer
//
// Description: Removes a character from our internal raw buffer 
//              TerminalDev->RawFIFO.  
//
// Input: 
...
//<AMI_PHDR_END>
//**********************************************************************
BOOLEAN RemoveCharFromRawBuffer(TERMINAL_DEV *TerminalDev, UINT8* pByte)
{
...
//<AMI_PHDR_START>
//
// Procedure: AddCharToUnicodeBuffer
//
// Description: Adds a character to our internal unicode buffer 
//              TerminalDev->UnicodeFIFO.
//
// Input: 
//      IN TERMINAL_DEV *TerminalDev
//      IN OUT CHAR16 UnicodeChar
//
// Output:
//  VOID
//
//<AMI_PHDR_END>
//**********************************************************************
VOID AddCharToUnicodeBuffer(TERMINAL_DEV *TerminalDev, CHAR16 UnicodeChar)
{
...
//<AMI_PHDR_START>
//
// Procedure: ExtractUtf8CharFromRawBuffer
//
// Description: Creates a Uft8 char from our internal raw buffer of 
//              characters TerminalDev->RawFIFO.  
//
// Input: 
//      IN TERMINAL_DEV *TerminalDev
//      IN OUT UTF8_CHAR* Utf8Char
//      IN OUT UINT8 *NumBytes
//
// Output:
//  BOOLEAN
//
//<AMI_PHDR_END>
//**********************************************************************
BOOLEAN ExtractUtf8CharFromRawBuffer(
...
//<AMI_PHDR_START>
//
// Procedure: ConvertUtf8ToUnicode
//
// Description: Creates a Unicode character from a Utf8 character. 
//
// Input: 
...
//      IN OUT CHAR16 *UnicodeChar
//
// Output: Creates a unicode char from the utf8 char.  
//  VOID
//
//<AMI_PHDR_END>
//**********************************************************************
...
//<AMI_PHDR_START>
//
// Procedure: FillUnicodeBufferFromSerial
//
// Description: Fills our internal Unicode buffer TerminalDev->UnicodeFIFO
...
//<AMI_PHDR_END>
//**********************************************************************
void FillUnicodeBufferFromSerial(TERMINAL_DEV *TerminalDev)
{
    UINTN FreeBuffer;
    UINTN AdjTail;
...
//<AMI_PHDR_START>
//
// Procedure: RemoveCharFromUnicodeBuffer
//
// Description: Removes a character from our internal 
...
//**********************************************************************
BOOLEAN
RemoveCharFromUnicodeBuffer(TERMINAL_DEV *TerminalDev, CHAR16* UnicodeChar)
{
...
// Procedure: PutBack
//
// Description: Puts the given Unicode character back into our internal 
//              character buffer TerminalDev->UnicodeFIFO.
//
// Input: 
//  IN TERMINAL_DEV *TerminalDev
...
//<AMI_PHDR_END>
//**********************************************************************
VOID PutBack(TERMINAL_DEV *TerminalDev, UINT16 UnicodeChar)
{
    //
    //buffer is full; can't put the character back
    //
    if (TerminalDev->UnicodeFIFO.Head==TerminalDev->UnicodeFIFO.Tail+1) return ;

    if (!TerminalDev->UnicodeFIFO.Head) TerminalDev->UnicodeFIFO.Head=BUFFER_SIZE;
...
//<AMI_PHDR_START>
//
// Procedure:   ASCIIControlCodeConversion
//
// Description: Convert the ASCII control codes into CTRL+Unicode(Key)values
//
// Input:
//              IN AMI_EFI_KEY_DATA *pKey - it contains unicode values. 
//  
//
// Output:
//              Converted Key Code
...
//<AMI_PHDR_END>
//**********************************************************************
VOID ASCIIControlCodeConversion(
...
//
// Description: The function polls the serial port to see if a key is 
//              available.
...
//<AMI_PHDR_START>
//
// Procedure: GetKeyFromSerial
//
// Description: Reads the serial port and returns a corresponding 
...
)
{
    ...
    if (EFI_ERROR(pBS->CheckEvent(TerminalDev->TimeoutEvent)))
    {
            ...
            if ((TerminalDev->EscSeqStatePtr->InputChar == InputChar) && (TerminalDev->EscSeqStatePtr->KeyPad & TerminalDev->PuttyKeyPad))
            {
                if (TerminalDev->EscSeqStatePtr->NextEscSeqState == NULL)
                {
                    ...
                    if (TerminalDev->EscSeqStatePtr->EfiInputKeyScanCode == RESET)
                        pRS->ResetSystem(EfiResetWarm, EFI_SUCCESS, 
                                            0, NULL);
        ...
        if (TerminalDev->EscSeqStatePtr == NULL) return EFI_SUCCESS;
    }
...
//<AMI_PHDR_START>
//
// Procedure: GetKeyData
//
// Description: Get the Keyboard Data 
//
// Input:
//              IN  TERMINAL_DEV    *TerminalDev, 
//              OUT VOID            *pKey,
...
//<AMI_PHDR_START>
//
// Procedure:   CheckKeyboardDataFromSerial
//
// Description: Check the Keyboard Data from Serial Port and Convert them 
...
)
{
    ...
    if (Ch != EFI_SCAN_NULL) {
        for (LookupTbl = EfiScanToEfiKey; LookupTbl->EfiScanCode; LookupTbl++) {
            if (LookupTbl->EfiScanCode == Ch) break;
        }
        ...
        if (Ch < 32) {
            ...
            EfiKey = CharToEfiTable[Ch].EfiKey;
            Ps2ScanCode = CharToEfiTable[Ch].Ps2ScanCode;
        }
    ...
    InsertKeyCode(&(TerminalDev->KeyboardBuffer),&TerminalKey);
...
//<AMI_PHDR_START>
//
// Procedure:   TerminalCommonReset
//
// Description: Terminal Keyboard Data buffer cleared 
//
// Input:
//              IN TERMINAL_DEV    *TerminalDev
...
//<AMI_PHDR_START>
//
// Procedure:   TerminalInputReadKey
//
...
//<AMI_PHDR_START>
//
// Procedure:   TerminalInputResetEx
//
// Description: In our implementation, this function does nothing. 
//
// Input:
...
//----------------------------------------------------------------------
//
// Procedure:       TerminalInputReadKeyEx
//
...
//----------------------------------------------------------------------
//
// Procedure:       TerminalInputSetState
//
...
//<AMI_PHDR_START>
//
// Procedure:   PollingTerminalKey
//
// Description: Get the keys from the Serial device
//
// Input:
//              IN EFI_EVENT    Event
//              IN VOID         *Context
...
//
// Paremeters:      KEY_WAITING_RECORD - *TerminalKeyIn
//
...
//----------------------------------------------------------------------
//
// Procedure:       TerminalInputRegisterKeyNotify
//
...
//----------------------------------------------------------------------
//
// Procedure:       TerminalInputUnRegisterKeyNotify
//
...
//----------------------------------------------------------------------
//
// Procedure:       TerminalInputReadEfiKey
//
// Description:     Reads the next keystroke from the input device and
...
//---------------------------------------------------------------------------
//
// Name:        InitTerminalKeyBuffer
//
// Description: Initialize Terminal Keyboard Buffer.
//
// Input:       IN TERMINAL_KB_BUFFER *KeyboardBuffer
//
// Output:      EFI_SUCCESS
//
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//
// Name:        IsTerminalKeyboardBufferEmpty
//
// Description: Check whether Terminal Keyboard buffer is empty.
//
// Input:       KeyboardBuffer  - pointer to Terminal Keyboard Buffer.
//
...
//---------------------------------------------------------------------------
//
// Name:        IsTerminalKeyboardBufferFull
//
// Description: Check whether Terminal Keyboard buffer is full.
//
// Input:       KeyboardBuffer  - pointer to Terminal Keyboard Buffer.
//
  ...
  )
{
    ...
    if (IsTerminalKeyboardBufferFull (KeyboardBuffer)) {	
        RemoveKeyCode(KeyboardBuffer,&TerminalKey);
    }
...
//
// Input:       KeyboardBuffer  - pointer to Terminal Keyboard Buffer.
//              TerminalKey          - pointer to buffer that contains Terminal key code.
//
// Output:      EFI_SUCCESS
//
//---------------------------------------------------------------------------
