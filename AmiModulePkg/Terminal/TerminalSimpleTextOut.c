...
//<AMI_FHDR_START>
//
// Name: TerminalSimpleTextOut.c
//
// Description: Implements the SimpleTextOut protocol for the Terminal.  
//
//<AMI_FHDR_END>
//**********************************************************************
...
//<AMI_PHDR_START>
//
// Procedure: isValidAnsi
//
// Description: Return TRUE is the given character value is less than 256  
...
//<AMI_PHDR_START>
//
// Procedure: isValidAscii
//
// Description: Return TRUE is the given character value is less than 128.  
//
// Input:
//  IN CHAR16 c
//
...
//<AMI_PHDR_START>
//
// Procedure: TranslateToAnsi
//
// Description: This function translates the Unicode drawing 
...
//
// Input:
//  IN CHAR16 c: Unicode drawing character.  
//
// Output:
//  CHAR8, extended ascii drawing character.
//
//<AMI_PHDR_END>
//**********************************************************************
CHAR8 TranslateToAnsi(CHAR16 c)
{
    UINTN i;
...
//
// Output:
//  CHAR8, ascii drawing character.
//
//<AMI_PHDR_END>
//**********************************************************************
CHAR8 TranslateToAscii(CHAR16 c)
{
    UINTN i;
...
//<AMI_PHDR_START>
//
// Procedure: WriteToSerialPort
//
// Description: Uses the SerialIo protocol's Write function.  
//
// Input:
//  IN UINT8 *Buffer
//  IN UINTN Length
...
//
// Description: Writes escape sequences to the seral port which 
...
//<AMI_PHDR_START>
//
// Procedure: UnicodeToUtf8
//
// Description: Utf8 is a character encoding for Unicode characters.  
//
...
//**********************************************************************
VOID
UnicodeToUtf8 (CHAR16 Unicode, UTF8_CHAR *Utf8Char, UINT8 *NumBytes)
{
...
//<AMI_PHDR_START>
//
// Procedure: TerminalOutputStringHelper
//
// Description: This is the function which writes a string to the screen.  
...
//<AMI_PHDR_END>
//**********************************************************************
EFI_STATUS TerminalOutputStringHelper (
    IN EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL  *This,
    IN CHAR16                           *String, 
    IN BOOLEAN                          UpdateCursorPosition
)
...
//<AMI_PHDR_START>
//
// Procedure: TerminalOutputString
//
// Description: Wrapper function for TerminalOutputStringHelper.  
...
//<AMI_PHDR_START>
//
// Procedure: TerminalOutputEscapeSequence
//
// Description: Calls TerminalOutputStringHelper with the 
...
//<AMI_PHDR_START>
//
// Procedure: TerminalTestString
//
// Description: Writes the given string to the screen.  
...
//<AMI_PHDR_START>
//
// Procedure: TerminalQueryMode
//
// Description: We only support whatever mode is specified by the setup
//              question "Resolution."
...
//<AMI_PHDR_START>
//
// Procedure: TerminalSetMode
//
// Description: In our implementation, we only support mode 0 and Mode 1, 
...
//<AMI_PHDR_START>
//
// Procedure: TerminalSetAttribute
//
// Description: Writes an escape sequence to the serial port 
...
//<AMI_PHDR_START>
//
// Procedure: TerminalSetCursorPosition
//
// Description: Writes an escape sequence to the serial port 
...
//<AMI_PHDR_START>
//
// Procedure: TerminalEnableCursor
//
// Description: In our implementation, the parameter Visible should be set
