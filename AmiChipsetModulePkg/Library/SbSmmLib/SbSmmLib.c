...
**/
#include <Token.h> //EIP135319
#include <Sb.h> //EIP135319
#include <Base.h>
...
/** CHIPSET PORTING IF NEEDED.
    IoWrite32(0x434,  BIT5);	//Clear APM SMI Status Bit
    IoWrite32(0x430, IoRead32 (0x430) | BIT1); //Set EOS Bit;
**/
	//EIP135319 >>
	IoWrite32((PM_BASE_ADDRESS + R_SMI_STS), BIT5); //Clear APM SMI Status Bit
	IoWrite32((PM_BASE_ADDRESS + R_SMI_EN), IoRead32((PM_BASE_ADDRESS + R_SMI_EN)) | BIT1); //Set EOS Bit;
	//EIP135319 <<
}
