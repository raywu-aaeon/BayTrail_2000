...
//****************************************************************************
//**********************************************************************
// $Header: /Alaska/SOURCE/Modules/SharkBayRefCodes/SwitchableGraphics/Sg TPV/Sg Acpi Tables/SgTpvPCH/ATiGPUPCH.asl 2     2/21/13 5:46a Joshchou $
//
// $Revision: 2 $
//
// $Date: 2/21/13 5:46a $
...
//            Store(0x000007FF,F1VM)	// Bit[10:0]Mask used for valid bit fields
            Store(0x00001FFF,F1VM)  // Bit[12:0]Mask used for valid bit fields
			...
			// Bit10=1: Indicates that full dGPU power off in gdynamic h scheme is supported, if set to one.
            ...
            If(LEqual(SGMD,0x2))
            {
              ...
              If(LEqual(PXFD,0x1))
              {
//                Store(0x00000680,F1FG)		// dGPU Power off under the Dynamic Scheme 
...
//                ASL_DGPUPCH_SCOPE.SGPO(SSEL, 1)
        ...
        If(LEqual(Arg0,4))
        {
            ...
            {
//                ASL_DGPUPCH_SCOPE.SGPO(ESEL, 0)
            }
            If(LEqual(SIMG,1))	// Switch I2C Muxes to dGFX
            {
//                ASL_DGPUPCH_SCOPE.SGPO(ESEL, 1)
            }
