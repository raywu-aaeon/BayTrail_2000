  ...
  )
{
  ...
  //
//*** AMI PORTING BEGIN ***//
// Bug fix: Comment out this check.
// When PE images are executed from ROM they are not aligned on a particular boundary.
// This function returns EFI_INVALID_PARAMETER and nothing is getting launched.
/*
  if (!(ImageContext->IsTeImage)) {
