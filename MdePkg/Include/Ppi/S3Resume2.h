...
**/
//*** AMI PORTING BEGIN ***//
// Bug fix: The name of the include guard macro is the same as the one used in S3Resume.h.
//	As a result, if one of the headers is included, the second one is not getting included.
#ifndef __PEI_S3_RESUME2_PPI_H__
#define __PEI_S3_RESUME2_PPI_H__
