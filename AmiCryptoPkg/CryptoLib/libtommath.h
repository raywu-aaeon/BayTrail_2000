...
// AP debug adds ~8k to target binary
#ifdef LTM_FAST
...
#endif
// AlexP mod
// allocate big var(4kb) in the Heap instead of Stack
mp_int  M[TAB_SIZE];
// AlexP mod end
 ...
 *
 * Uses a left-to-right k-aray sliding window to compute the modular exponentiation.
