...
**/
//*** AMI PORTING BEGIN ***//
// Partition GUID support:
// According to the UEFI specification (Page 111, section 5.3.3):
// "The firmware must add the PartitionTypeGuid to the handle of every active GPT partition 
// using InstallProtocolInterface()."
// Original code was not installing partition GUID on the partition handle.
//*** AMI PORTING END ***//
EFI_STATUS
