  ...
  )
{
  ...
  // 64-bit operations support
    ...
    if ((PciLibAddress & 0x03) == 0) {
      ...
      //
      WriteUnaligned32 (((UINT32 *) Buffer), PciRead32 (PciLibAddress));
      WriteUnaligned32 (((UINT32 *) Buffer + 1), PciRead32 (PciLibAddress + 4));
    } else if ((PciLibAddress & 0x01) == 0) {
      //
      // Unaligned Pci address access, break up the request into word by word.
      //
      WriteUnaligned16 (((UINT16 *) Buffer), PciRead16 (PciLibAddress));
      WriteUnaligned16 (((UINT16 *) Buffer + 1), PciRead16 (PciLibAddress + 2));
      WriteUnaligned16 (((UINT16 *) Buffer + 2), PciRead16 (PciLibAddress + 4));
      WriteUnaligned16 (((UINT16 *) Buffer + 3), PciRead16 (PciLibAddress + 6));
    } else {
      //
      // Unaligned Pci address access, break up the request into byte by byte.
      //
      ...
      *((UINT8 *) Buffer + 2) = PciRead8 (PciLibAddress + 2);
      *((UINT8 *) Buffer + 3) = PciRead8 (PciLibAddress + 3);
      *((UINT8 *) Buffer + 4) = PciRead8 (PciLibAddress + 4);
      *((UINT8 *) Buffer + 5) = PciRead8 (PciLibAddress + 5);
      *((UINT8 *) Buffer + 6) = PciRead8 (PciLibAddress + 6);      
      *((UINT8 *) Buffer + 7) = PciRead8 (PciLibAddress + 7);      
    }
  //*** AMI PORTING END *****//     
  } else {
  ...
  )
{
  ...
  // 64-bit operations support
    ...
    if ((PciLibAddress & 0x03) == 0) {
      ...
      //
      PciWrite32 (PciLibAddress, ReadUnaligned32 ((UINT32 *) Buffer));
      PciWrite32 (PciLibAddress+4, ReadUnaligned32 ((UINT32 *) Buffer + 1));
    } else if ((PciLibAddress & 0x01) == 0) {
      //
      // Unaligned Pci address access, break up the request into word by word.
      //
      PciWrite16 (PciLibAddress, ReadUnaligned16 ((UINT16 *) Buffer));
      PciWrite16 (PciLibAddress + 2, ReadUnaligned16 ((UINT16 *) Buffer + 1));
      PciWrite16 (PciLibAddress + 4, ReadUnaligned16 ((UINT16 *) Buffer + 2));
      PciWrite16 (PciLibAddress + 6, ReadUnaligned16 ((UINT16 *) Buffer + 3));
    } else {
      //
      // Unaligned Pci address access, break up the request into byte by byte.
      //
      ...
      PciWrite8 (PciLibAddress + 2, *((UINT8 *) Buffer + 2)); 
      PciWrite8 (PciLibAddress + 3, *((UINT8 *) Buffer + 3)); 
      PciWrite8 (PciLibAddress + 4, *((UINT8 *) Buffer + 4)); 
      PciWrite8 (PciLibAddress + 5, *((UINT8 *) Buffer + 5)); 
      PciWrite8 (PciLibAddress + 6, *((UINT8 *) Buffer + 6));     
      PciWrite8 (PciLibAddress + 7, *((UINT8 *) Buffer + 7));     
    }
  //*** AMI PORTING END *****// 
  } else {
    return EFI_INVALID_PARAMETER;
  ...
  )
{
  ...
  // 64-bit operations support
    ...
    if ((PciLibAddress & 0x03) == 0) {
      ...
      PciAndThenOr32 (PciLibAddress + 4, ClearValue32, SetValue32);
    } else if ((PciLibAddress & 0x01) == 0) {
      //
      // Unaligned Pci address access, break up the request into word by word.
      //
      ...
      PciAndThenOr16 (PciLibAddress + 4, ClearValue16, SetValue16);      

      ClearValue16  = (UINT16) (~ReadUnaligned16 ((UINT16 *) ClearBits + 3));
      SetValue16    = ReadUnaligned16 ((UINT16 *) SetBits + 3);
      PciAndThenOr16 (PciLibAddress + 6, ClearValue16, SetValue16);      
    } else {
      //
      // Unaligned Pci address access, break up the request into byte by byte.
      //
      ...
      PciAndThenOr8 (PciLibAddress + 2, (UINT8) (~(*((UINT8 *) ClearBits + 2))), *((UINT8 *) SetBits + 2));
      PciAndThenOr8 (PciLibAddress + 3, (UINT8) (~(*((UINT8 *) ClearBits + 3))), *((UINT8 *) SetBits + 3));
      PciAndThenOr8 (PciLibAddress + 4, (UINT8) (~(*((UINT8 *) ClearBits + 4))), *((UINT8 *) SetBits + 4));
      PciAndThenOr8 (PciLibAddress + 5, (UINT8) (~(*((UINT8 *) ClearBits + 5))), *((UINT8 *) SetBits + 5));
      PciAndThenOr8 (PciLibAddress + 6, (UINT8) (~(*((UINT8 *) ClearBits + 6))), *((UINT8 *) SetBits + 6));      
      PciAndThenOr8 (PciLibAddress + 7, (UINT8) (~(*((UINT8 *) ClearBits + 7))), *((UINT8 *) SetBits + 7));
    }
  //*** AMI PORTING END *****//	    
  } else {
    return EFI_INVALID_PARAMETER;
