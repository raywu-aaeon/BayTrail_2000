  ...
  )
{
  ...
  //
  //*** AMI PORTING BEGIN ***//
  // A similar debug message in DxeMain and PeiMain are reported with just the DEBUG_INFO mask.
  // Update debug mask here for a consistency in displaying interface publishing debug messages.
