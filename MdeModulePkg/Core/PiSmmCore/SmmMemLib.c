  ...
  )
{
  ...
  //mSmmMemLibInternalSmramRanges = (EFI_SMRAM_DESCRIPTOR *)AllocatePool (Size);
  mSmmMemLibInternalSmramRanges = (EFI_SMRAM_DESCRIPTOR *)SmramRangesBuff;
