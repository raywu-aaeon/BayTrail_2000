...
typedef struct {
  ...
  //*** AMI PORTING BEGIN ***//
  // The original definition is not compatible with certain chipsets where SmmPort number is greater than 255.
  ///
...
//*** AMI PORTING BEGIN ***//
// There are boards with more than 8 IDE channels.
// Increase the number to 12.
