...
#define   N_PLATFORM_ID_BITS        50
#define   B_PLATFORM_ID_BITS_MASK   (BIT52 | BIT51 | BIT50)
...
#define MSR_PSB_CLOCK_STATUS        0xcd
  #define FUSE_BSEL_MASK            3	//Bit field define for Valleyvew is [1:0]
...
#define MSR_IA32_THERM_STATUS    0x19c
  #define B_POWER_LIMIT_LOG         BIT11
...
UINT32 GetCpuApicId(IN VOID *MpData, IN UINT32 Cpu);
...
BOOLEAN IsX2ApicRequired(VOID *MpData);
